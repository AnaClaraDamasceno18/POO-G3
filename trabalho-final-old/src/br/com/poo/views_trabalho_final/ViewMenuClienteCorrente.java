...
public class ViewMenuClienteCorrente extends JFrame {
	...
	public ViewMenuClienteCorrente(String cpf) {
		this.cpf = cpf;
		initialize();
	}
	...
	public void initialize() {
		...
		ViewMenuCliente.setTitle("*CapyBank* - Menu Cliente Conta Corrente");
		...
		JButton btnSimulRendPoup = new JButton("Tributações");
		btnSimulRendPoup.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
