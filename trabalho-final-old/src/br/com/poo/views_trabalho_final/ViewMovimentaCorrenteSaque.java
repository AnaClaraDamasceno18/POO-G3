...
public class ViewMovimentaCorrenteSaque extends JFrame {
	...
	public void initialize() {
		...
		ViewSaque.setTitle("*CapyBank* - Saque Conta Corrente");
...
//		ViewSaque.add(mostarNomeCliente);
	...
	private void btnConfirmSaque(ActionEvent actionEvent) {
		...
		Double valorDoSaque = Double.parseDouble(textValorSaque.getText());
		

			switch (resposta) {
			case 0:
				ContaPoupanca cp = new ContaPoupanca();
				cp.movimentacaoBancaria(valorDoSaque, cpf);
	...
	private br.com.poo.contas.ContaPoupanca ContaPoupanca() {
		return null;
	}

	private ContaPoupanca ContaPoupanca(String tipoConta, String agencia, String numConta, String titular, String cpf2,
			Double saldo) {
		return null;
	}
